...
.PHONY: build
build:
	docker build -t digitalmarketplace-aws-brief-responses-frontend-http --build-arg DM_APP_NAME=brief-responses-frontend -f docker-aws/Dockerfile.http .
	docker build -t digitalmarketplace-aws-brief-responses-frontend-wsgi -f docker-aws/Dockerfile.wsgi .
